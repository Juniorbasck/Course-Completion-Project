...
\documentclass[12pt,english,brazilian]{UNISINOSmonografia}
...
\setlength{\parindent}{1cm} % Define o recuo da primeira linha de cada parágrafo
...
\usepackage{quoting}
\usepackage{titlesec}
\titleformat{\chapter}[hang]{\bfseries\Large}{\thechapter}{1pc}{}
\titlespacing{\chapter}{0pt}{0pt}{1pc} % Remove espaçamentos extras nos capítulos

\titleformat{\section}[hang]{\bfseries\normalsize}{\thesection}{1pc}{}
\titlespacing{\section}{1pt}{1pt}{1pc} % Remove espaçamento extra antes da seção

\titleformat{\subsection}[hang]{\bfseries\large}{\thesubsection}{1pc}{}
\titlespacing{\subsection}{0pt}{1pt}{1pc} % Remove espaçamento extra antes da subseção
